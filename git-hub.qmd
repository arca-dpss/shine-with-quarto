...
```{r}
#| fig-align: center
#| fig-cap: Create a new repository that does exist yet
...
```{r}
#| fig-align: center
#| fig-cap: Add an existing repository that does exist yet
#| fig-cap-location: top
...
Once a repository is added (either by adding an existing or creating a new one), it can be published and made available online for other people: 
...
As you can see, the `index` file has been taken as the default landing page of your website. 
...
This flow applies to any document you modify locally.
